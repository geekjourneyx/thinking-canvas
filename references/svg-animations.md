# SVG Animations — thinking-canvas Reference

Inline SVG/CSS/SMIL animation techniques for standalone HTML canvases.
Read this when adding animation to a visual render.
